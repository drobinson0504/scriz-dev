    ...
    <section>
        <div class="row">
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail"> <img src="imgs/free-code-image.jpg" alt="...">
                    <div class="caption">
                        <h3>Who we are</h3>
                        <p>We are a collective, movement, friends and a family. We are entrepreneurs, volunteers, professionals, and leaders that come to together as a team to help others improve their code while helping businesses and individuals develop themselves on the World Wide Web. We share our ideas and work together to improve ourselves and build greatness. SCRZ Development is about the collaboration of the ideas from individuals that aim to make a difference.</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-md-4">
